...
void main() => runApp(const ScheduleScreen());
...
class CalendarAppointment extends State<ScheduleScreen> {
  ...
  final ScheduleApiService schedulesApiService = ScheduleApiService();
